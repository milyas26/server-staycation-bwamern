...
module.exports = {
  ...
  viewDetailItem: async (req, res) => {
    ...
    try {
      ...
      console.log(feature);res.render('admin/item/detail_item/view_detail_item', {
  ...
  addFeature: async (req, res) => {
    ...
    try {
      ...
      await item.save();
      req.flash('alertMessage', 'Success Menambahkan Feature');
      req.flash('alertStatus', 'success');
      res.redirect(`/admin/item/show-detail-item/${itemId}`);
    } catch (error) {
      req.flash('alertMessage', `${error.message}`);
  ...
  addActivity: async (req, res) => {
    ...
    try {
      ...
      await item.save();
      req.flash('alertMessage', 'Success Menambahkan Activity');
      req.flash('alertStatus', 'success');
      res.redirect(`/admin/item/show-detail-item/${itemId}`);
    } catch (error) {
      req.flash('alertMessage', `${error.message}`);
